...
class IntrinsicCalibrator():
    ...
    def save_params(self, paramPath, cameraMatrix, newCameraMatrix, distortionCoefficients, ):
    ...
    def load_params(self, paramPath):
    ...
    def calibrate_fisheye_from_corners(self, imageKeypointsIn):
    ...
    def calibrate_pinhole_from_corners(self, imageKeypoints):
    ...
    def calibrate_from_images(self, paramPath, imgPaths, cameraType=1):
        ...
        if cameraType == 0:
            cameraMatrix, newCameraMatrix, distortionCoefficients = self.calibrate_pinhole_from_corners(cornersList)
        elif cameraType == 1:
